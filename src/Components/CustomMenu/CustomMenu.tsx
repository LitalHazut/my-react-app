...
import { TopMenu } from '../TopMenu.tsx/TopMenu';
            ...
            <div style={{ position: 'fixed', top: 0, right: 0, height: '100%', backgroundColor: '#2785ba', zIndex: 1000, width: collapsed ? '120px' : '175px', transition: 'width 0.3s' }}>
                ...
                {collapsed ? (
                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginLeft: '3px', marginBottom: '5px' }}>
                        <p style={{ fontSize: '12px', marginTop: '5px', marginBottom: '0', color: 'white' }}>,שלום</p>
                        <p style={{ fontSize: '12px', marginTop: '0', marginBottom: '0', color: 'white' }}>ישראל ישראלי</p>
                    </div>
                ) : (
                ...
                <div style={{ textAlign: 'right', color: 'white', paddingTop: '10px' }}>
                    {!collapsed ? (
                        <>
                            <div>
                                <div style={{ fontSize: '12px', color: 'white', marginRight: '7px', fontWeight: 'bold' }}>
                                    ניהול כללי
                                </div>
                                <div style={{ color: 'white', fontSize: '10px', marginRight: '15px' }}>ניהול משימות</div>
                                <div style={{ color: 'white', fontSize: '10px', marginRight: '15px' }}>שליחת מסרון מלל חופשי</div>
                            </div>
                            <div style={{ paddingTop: '30px' }}>
                                <div style={{ fontSize: '12px', color: 'white', marginRight: '7px', fontWeight: 'bold' }}>
                                    ניהול גמלאות
                                </div>
                                <div style={{ color: 'white', fontSize: '10px', marginRight: '15px' }}>
                                    'אופציה א
                                </div>
                                <div style={{ color: 'white', fontSize: '10px', marginRight: '15px' }}>
                                    'אופציה ב
